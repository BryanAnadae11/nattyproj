...
(function ($) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    const openButton = document.querySelector(".view-btn");
...
function setTheme(themeName) {
  localStorage.setItem("globaldivineinvestment_theme", themeName);
  document.documentElement.className = themeName;
}
function toggleTheme() {
  if (localStorage.getItem("globaldivineinvestment_theme") === "theme-dark") {
...
// Function to interchange words "Transfer" and "Withdraw"
function interchangeWords() {
  var typewriterElement = document.getElementById('typewriter');
  
  if (typewriterElement.textContent === "TRANSFER") {
    typewriterElement.textContent = "WITHDAW";
  } else {
    typewriterElement.textContent = "TRANSFER";
  }
}

// Set interval to interchange words every 3 seconds
setInterval(interchangeWords, 10000);
